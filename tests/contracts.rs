...
fn activated_projection() -> ActivatedProjection {
    ...
    ActivatedProjection {
        ...
        activated_objects: vec![ActivatedObjectRecord {
            object_id: object_id(),
            title: "Capital".into(),
            aliases: vec!["Capital alias".into()],
            object_class: "concept".into(),
            visible_region_addresses: vec![region_address()],
        ...
        activated_identifier_assignments: vec![ActivatedIdentifierAssignmentRecord {
            assignment_id: "assignment:note_type".into(),
            identifier_name: "source_material".into(),
            subject: SemanticAddress::Object(object_id()),
            value: IdentifierValue::String("source_material".into()),
            record_provenance: RecordProvenance::ObjectField {
                object_id: object_id(),
                field_path: "type".into(),
            },
            available_surface_ids: vec!["surface:exact".into()],
            activation_provenance: provenance.clone(),
        }],
        activated_occurrences: vec![ActivatedOccurrenceRecord {
            occurrence_id: occurrence_id(),
            source: OccurrenceSource::SemanticUnit { unit_id: unit_id() },
            authored_target_text: "Capital".into(),
            display_alias: Some("Capital".into()),
            resolved_target: SemanticAddress::Object(object_id()),
            presentation_mode: OccurrencePresentation::Link,
            direction: Direction::Outgoing,
            source_span: Some(SourceSpan {
