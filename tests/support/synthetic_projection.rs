...
pub fn tiny_projection() -> SemanticSpaceProjection {
    ...
    let occurrences = vec![
        OccurrenceRecord {
            ...
            display_alias: None,
            resolved_target: Some(SemanticAddress::Object(marx.clone())),
        ...
        OccurrenceRecord {
            ...
            display_alias: None,
            resolved_target: Some(SemanticAddress::Region(marx_region.clone())),
            resolution_state: OccurrenceResolutionState::Resolved,
            presentation_mode: OccurrencePresentation::Link,
            direction: Direction::Outgoing,
            source_span: None,
        ...
        OccurrenceRecord {
            ...
            resolved_target: Some(SemanticAddress::Unit(capital_two.clone())),
            resolution_state: OccurrenceResolutionState::Resolved,
            presentation_mode: OccurrencePresentation::Link,
            direction: Direction::Outgoing,
            source_span: None,
        ...
        OccurrenceRecord {
            ...
            display_alias: None,
            resolved_target: Some(SemanticAddress::Object(cleo.clone())),
            resolution_state: OccurrenceResolutionState::Resolved,
            presentation_mode: OccurrencePresentation::Link,
            direction: Direction::Outgoing,
            source_span: None,
    ...
    SemanticSpaceProjection {
        ...
        temporal_anchors: vec![
            TemporalAnchorRecord {
                ...
                value: TemporalValue::FullDate("2026-07-02".into()),
            ...
            TemporalAnchorRecord {
                ...
                value: TemporalValue::FullDate("2026-07-15".into()),
